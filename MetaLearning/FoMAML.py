...
try:
    ...
    torch.save({
                ...
                }, 'C:/telun/FCN/Evaluation_exp2/FoMAML_FCN/model/FoMAML_init_v1.pth')
    # v0 --> 
    # {inner_lr = 0.01,
    #  lr = 0.0085,
    #  meta_epoch = 50,
    ...
    txtpath = 'C:/telun/FCN/Evaluation_exp2/FoMAML_FCN/record/MetaTime.txt'
    f = open(txtpath, 'w')
    f.write(str(Time))
    f.close()
